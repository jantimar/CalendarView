...
struct Page {
    ...
    var weeks: [Week] {
        ...
        var daysInPreviousMonth:[Day] = []

        for i in (0 ..< firstDayInMonth).reversed() {
            daysInPreviousMonth.append(Day(number: previousMonthDays - i,isEnabled: false))
        }
...
final public class CalendarViewModel: ObservableObject {
    ...
    var formattedDate: String {
        ...
        let month = current.month // get month
